...
`ensure_distinct_parents = TRUE` (default) ensures that parent sequences are
sufficiently different, making the chimeras detectable.
...
The `ensure_distinct_parents` parameter (default TRUE) helps avoid this issue.
